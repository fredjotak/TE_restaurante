                ...
                <div class="contenido">
                    ...
                    <div class="contenido__cuerpo">
                        <div class="cliente-buscar">
                            <form action="UsuarioControlador?action=search" method="GET">
                            ...
                            <a href="UsuarioControlador?action=add">
                                            ...
                                            <div class="acciones-edit-eli">
                                                <ul>
                                                    <li class="accion_indep">
                                                        ...
                                                        <a href="UsuarioControlador?action=edit&id=${item.id}">Editar</a>
                                                    </li>
                                                    <li class="accion_indep">
                                                        ...
                                                        <a href="UsuarioControlador?action=delete&id=${item.id}" onclick="return confirm('¿Estas seguro de eliminar el usuario con id ${item.id}?')">Eliminar</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
