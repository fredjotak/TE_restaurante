    ...
    <body>
        ...
        <main class="principal">
            ...
            <article class="contenedor-contenido">
                <div class="contenido">
                    ...
                    <!--action="UsuarioControlador?action=search" method="GET"-->
                    <div class="contenido__cuerpo">
                        <div class="cliente-buscar">
                            <form action="" name="BuscarUsuarios">
                                <input type="hidden" name="action" value="search">
                                <input type="text" name="v" placeholder="Buscar por Nombre o RNC">
                                <!--<div class="submit">
                                    ...
                                    <input id="buscarUsuario" type="submit" value="Buscar" name="buscar">
                                </div>-->
                            </form>
                            <a class="abrirform">
                        ...
                        <table class="crud crud-table--usuarios">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>C.I.</th>
        ...
        <div class="modal">
            <div class="form-contenedor">
                <div class="form-titulo">
                    ...
                    <h2 id="crud-titulo">Nuevo Usuario</h2>                
                </div>
                <div class="form-contenido">
                    <form name="formCrud" action="UsuarioControlador" class="form_edit-nuevo cliente" method="POST">
                        <input type="hidden" name="hdnId" value="0" >
                            <div class="rows">
                            ...
                            <div class="rows">
                                ...
                                <input type="number" name="nroCI" id="nroCI" step="1" required>
                            </div>
                            <div class="rows">
        ...
        <template id="crud-template">
            <tr>
                ...
                <td class="cu-paterno"></td>
                <td class="cu-materno"></td>
                <td class="cu-usuario"></td>
                <td class="cu-rol"></td>
                <td class="acciones">
