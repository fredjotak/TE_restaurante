                ...
                <div class="contenido">
                    ...
                    <div class="contenido__cuerpo">
                        <div class="cliente-buscar">
                            <form action="CategoriaControlador" method="GET">
                                <input type="hidden" name="action" value="search">
                                <input type="text" name="vc" placeholder="Buscar por Nombre">
                                <div class="submit">
                            ...
                            <a href="CategoriaControlador?action=add">
                                            ...
                                            <div class="acciones-edit-eli">
                                                <ul>
                                                    <li class="accion_indep">
                                                        ...
                                                        <a href="CategoriaControlador?action=edit&id=${item.id}">Editar</a>
                                                    </li>
                                                    <li class="accion_indep">
                                                        ...
                                                        <a href="CategoriaControlador?action=delete&id=${item.id}" onclick="return confirm('¿Estas seguro de eliminar la categoria con id ${item.id}?')">Eliminar</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
