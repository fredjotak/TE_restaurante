                ...
                <div class="contenido">
                    ...
                    <div class="contenido__cuerpo">
                        <div class="cliente-buscar">
                            <form action="MesaControlador" method="get">
                                <input type="hidden" name="action" value="search">
                                <input type="text" name="vm" placeholder="Buscar por nombre de mesa">
                                <div class="submit">
                            ...
                            <a href="MesaControlador?action=add">
                                            ...
                                            <div class="acciones-edit-eli">
                                                <ul>
                                                    <li class="accion_indep">
                                                        ...
                                                        <a href="MesaControlador?action=edit&id=${item.id}">Editar</a>
                                                    </li>
                                                    <li class="accion_indep">
                                                        ...
                                                        <a href="MesaControlador?action=delete&id=${item.id}" onclick="return confirm('¿Estas seguro de eliminar la mesa con id ${item.id}?')">Eliminar</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
