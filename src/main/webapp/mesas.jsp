    ...
    <body>
        ...
        <template id="crud-template">
            <tr>
                ...
                <td class="cu-encargado"></td>
                <td class="cu-ocupada"></td>
                <td class="acciones">
                        ...
                        <div class="acciones-edit-eli">
                            <ul>
                                ...
                                <li class="accion_indep">
                                    ...
                                    <a class="cu-delete" onclick="return confirm('¿Estas seguro de eliminar el producto?')">Eliminar</a>
                                </li>
                            </ul>
                        </div>
                    </div>
