                    ...
                    <div class="contenido__cuerpo">
                        <div class="cliente-buscar">
                            <form action="ProductoControlador">
                                ...
                                <input type="text" name="vp" placeholder="Buscar por Nombre de producto">
                                <div class="submit">
                            ...
                            <a href="ProductoControlador?action=add">
                                            ...
                                            <div class="acciones-edit-eli">
                                                <ul>
                                                    <li class="accion_indep">
                                                        ...
                                                        <a href="ProductoControlador?action=edit&id=${item.id}">Editar</a>
                                                    </li>
                                                    <li class="accion_indep">
                                                        ...
                                                        <a href="ProductoControlador?action=delete&id=${item.id}" onclick="return confirm('¿Estas seguro de eliminar el producto con id ${item.id}?')">Eliminar</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
